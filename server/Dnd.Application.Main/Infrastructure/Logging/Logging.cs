...
namespace Dnd.Application.Main.Infrastructure.Logging;

public class DndLoggerProvider : ILoggerProvider
{
    private readonly string _prefix;
    private readonly ILoggerProvider _loggerProvider;

    public DndLoggerProvider(string prefix, ILoggerProvider loggerProvider)
    {
        _prefix = prefix;
